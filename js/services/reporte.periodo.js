...
/* Estados "reparado/terminado": ahora centralizados en core/estados.js */
...
export async function datosReportePeriodo(desde, hasta) {
  ...
  for (const a of abonos) {
    ...
    for (const [, pago] of Object.entries(a.pagos || {})) {
      if (enRango(pago.fecha, desde, hasta)) {
        const monto = parseFloat(pago.monto || 0) || parseFloat(a.cuota || 0) || 0;
        cobradoEnPeriodo += monto;
      }
    }
