...
import { pesos, escapeHtml, modalReady, mensajeAmigable } from '../core/utils.js';
...
export async function abrirFormularioOTE(preset = null) {
  ...
  /* Precarga (ej: desde un mantenimiento programado) */
...
function _readOTE() {
  ...
  return {
    ...
    fecha:             v('ote-fecha')          || new Date().toISOString().slice(0, 10),
...
export function abrirFormularioVisita() {
  abrirFormularioOTE({
