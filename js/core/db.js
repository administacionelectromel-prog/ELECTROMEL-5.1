...
export const DB_SCHEMA = {
  ...
  viajes_operativos: {
    options: { keyPath: 'id', autoIncrement: true },
    indices: [
      { name: 'ciudad',        key: 'ciudad' },
      { name: 'fecha_salida',  key: 'fecha_salida' },
      { name: 'estado',        key: 'estado' },
      { name: 'anio',          key: 'anio' }
    ]
  },
...
export function openDB() {
  return new Promise((resolve, reject) => {
    ...
    req.onupgradeneeded = (ev) => {
      ...
      /* v16: nuevos stores "ciudades_op" y "viajes_operativos" para
              el gasto operativo por viaje (se crean solos en el loop). */

      /* v17: nuevo store "campanias" (marketing/origen de clientes).
              Se crea solo en el loop de abajo. */
